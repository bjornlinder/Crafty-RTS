...
Crafty.c('Creep', {
	init: function() {
		this.requires('Actor, spr_apple, SpriteAnimation')
		...
		//this.y == 20;
		//this.xspeed = 10
		//console.log(this._x) +"._x"
		//console.log(this.at(5,8))
		//console.log(this)
		//this._movement.x = 1
		//this.bind("EnterFrame", this._movement.x=1){};
		
		//this.bind("EnterFrame", this.moveRight)}
		//moveRight: function(){this._movement.x+=1}
