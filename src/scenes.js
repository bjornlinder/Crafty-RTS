...
Crafty.scene('Game', function() {
	...
	this.player = Crafty.e('PlayerCharacter').at(10, 5);
	...
	Crafty.e("Creep").delay(function() {
		Crafty.e("Creep").at(3,3);
	},	spawn_interval, creep_count - 2	//will need to update the creep count/clean method.
	);
	
	//Joe = Crafty.e('Creep').at(6,3);
	
	//console.log(Crafty.math.distance(30,30,50,50));
